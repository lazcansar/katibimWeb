            ...
            <form onSubmit={handleLogin}>
                <div className="flex flex-col items-center justify-center border border-teal-900 rounded-lg px-4 py-2 my-4">
                    ...
                    <div className="flex flex-row gap-4 items-center justify-center">
                        ...
                        <button className="py-2 px-4 dark:bg-amber-700 dark:text-white bg-amber-700 text-teal-950 rounded-lg my-2 uppercase transition hover:bg-amber-600 cursor-pointer" type="submit" onClick={passwordReset}>Şifremi Unuttum</button>
                    </div>
